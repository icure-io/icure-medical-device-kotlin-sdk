...
inline fun <reified F:Any, reified T:Any> Filter<F>.toAbstractFilterDto() = this.toAbstractFilterDto(F::class, T::class)
...
fun Filter<HealthcareProfessional>.healthcareProfessionalFilterToAbstractHealthcarePartyFilterDto(): AbstractFilterDto<HealthcarePartyDto> = when(this) {
    is ComplementFilter<HealthcareProfessional> -> this.toComplementFilterDto(HealthcareProfessional::class, HealthcarePartyDto::class)
    is UnionFilter<HealthcareProfessional> -> this.toUnionFilterDto(HealthcareProfessional::class, HealthcarePartyDto::class)
    is IntersectionFilter<HealthcareProfessional> -> this.toIntersectionFilterDto(HealthcareProfessional::class, HealthcarePartyDto::class)
...
fun Filter<HealthcareElement>.healthcareElementFilterToAbstractHealthElementFilterDto(): AbstractFilterDto<HealthElementDto> = when(this) {
    is ComplementFilter<HealthcareElement> -> this.toComplementFilterDto(HealthcareElement::class, HealthElementDto::class)
    is UnionFilter<HealthcareElement> -> this.toUnionFilterDto(HealthcareElement::class, HealthElementDto::class)
    is IntersectionFilter<HealthcareElement> -> this.toIntersectionFilterDto(HealthcareElement::class, HealthElementDto::class)
...
fun CodeByRegionTypeLabelFilter.toCodeByRegionTypeLabelFilterDto(): io.icure.kraken.client.models.filter.code.CodeByRegionTypeLabelLanguageFilter {
    return io.icure.kraken.client.models.filter.code.CodeByRegionTypeLabelLanguageFilter(this.description, this.region, this.type, this.language, this.label)
}
...
fun DataSampleByHealthcarePartyIdentifiersFilter.toDataSampleByHealthcarePartyIdentifiersFilterDto(): io.icure.kraken.client.models.filter.service.ServiceByHcPartyIdentifiersFilter {
    return io.icure.kraken.client.models.filter.service.ServiceByHcPartyIdentifiersFilter(this.healthcarePartyId, this.description, this.identifiers.map { it.toIdentifierDto() })
}
...
fun DataSampleByHealthcarePartyLabelCodeDateFilter.toDataSampleByHealthcarePartyLabelCodeDateFilterDto(): io.icure.kraken.client.models.filter.service.ServiceByHcPartyTagCodeDateFilter {
    return io.icure.kraken.client.models.filter.service.ServiceByHcPartyTagCodeDateFilter(this.description, this.healthcarePartyId, null, this.tagType, this.tagCode, this.codeType, this.codeCode, this.startValueDate, this.endValueDate)
}
...
fun DataSampleByPatientFilter.toDataSampleByPatientFilterDto(): io.icure.kraken.client.models.filter.service.ServiceBySecretForeignKeys {
    return io.icure.kraken.client.models.filter.service.ServiceBySecretForeignKeys(this.description, this.healthcarePartyId, this.patientSecretForeignKeys)
}
...
fun HealthcareElementByHealthcarePartyIdentifiersFilter.toHealthcareElementByHealthcarePartyIdentifiersFilterDto(): io.icure.kraken.client.models.filter.healthelement.HealthElementByHcPartyIdentifiersFilter {
    return io.icure.kraken.client.models.filter.healthelement.HealthElementByHcPartyIdentifiersFilter(this.description, this.healthcarePartyId, this.identifiers.map { it.toIdentifierDto()})
}
...
fun HealthcareElementByHealthcarePartyLabelCodeFilter.toHealthcareElementByHealthcarePartyLabelCodeFilterDto(): io.icure.kraken.client.models.filter.healthelement.HealthElementByHcPartyTagCodeFilter {
    return io.icure.kraken.client.models.filter.healthelement.HealthElementByHcPartyTagCodeFilter(this.description, this.healthcarePartyId, this.codeType, this.codeNumber, this.tagType, this.tagCode)
}
...
fun PatientByHealthcarePartyAndIdentifiersFilter.toPatientByHealthcarePartyAndIdentifiersFilterDto(): io.icure.kraken.client.models.filter.patient.PatientByHcPartyAndIdentifiersFilter {
    return io.icure.kraken.client.models.filter.patient.PatientByHcPartyAndIdentifiersFilter(this.description, this.healthcarePartyId, this.identifiers.map { it.toIdentifierDto() })
}
...
fun PatientByHealthcarePartyDateOfBirthBetweenFilter.toPatientByHealthcarePartyDateOfBirthBetweenFilterDto(): io.icure.kraken.client.models.filter.patient.PatientByHcPartyDateOfBirthBetweenFilter {
    return io.icure.kraken.client.models.filter.patient.PatientByHcPartyDateOfBirthBetweenFilter(this.description, this.minDateOfBirth, this.maxDateOfBirth, this.healthcarePartyId)
}
...
fun PatientByHealthcarePartyGenderEducationProfession.toPatientByHealthcarePartyGenderEducationProfessionDto(): io.icure.kraken.client.models.filter.patient.PatientByHcPartyGenderEducationProfession {
    return io.icure.kraken.client.models.filter.patient.PatientByHcPartyGenderEducationProfession(this.description, this.healthcarePartyId, this.gender?.toDbGender(), this.education, this.profession )
}
...
fun PatientByHealthcarePartyNameContainsFuzzyFilter.toPatientByHealthcarePartyNameContainsFuzzyFilterDto(): io.icure.kraken.client.models.filter.patient.PatientByHcPartyNameContainsFuzzyFilter {
    return io.icure.kraken.client.models.filter.patient.PatientByHcPartyNameContainsFuzzyFilter(this.description, this.searchString, this.healthcarePartyId)
}
...
fun PatientByHealthcarePartyNameFilter.toPatientByHealthcarePartyNameFilterDto(): io.icure.kraken.client.models.filter.patient.PatientByHcPartyNameFilter {
    return io.icure.kraken.client.models.filter.patient.PatientByHcPartyNameFilter(this.description, this.name, this.healthcarePartyId)
}
...
fun <F:Any, T:Any> ComplementFilter<F>.toComplementFilterDto(from: KClass<F>, to: KClass<T>) : io.icure.kraken.client.models.filter.ComplementFilter<T> =
    io.icure.kraken.client.models.filter.ComplementFilter(this.description, this.superSet.toAbstractFilterDto(from, to), this.subSet.toAbstractFilterDto(from, to))

@Suppress("UNCHECKED_CAST")
inline fun <reified F:Any, reified T:Any> UnionFilter<F>.toUnionFilterDto() =
    this.toUnionFilterDto(F::class, T::class)
fun <F:Any, T:Any> UnionFilter<F>.toUnionFilterDto(from: KClass<F>, to: KClass<T>) : io.icure.kraken.client.models.filter.UnionFilter<T> =
    io.icure.kraken.client.models.filter.UnionFilter(this.description, this.filters.map { it.toAbstractFilterDto(from, to) })
...
fun <F:Any, T:Any> IntersectionFilter<F>.toIntersectionFilterDto(from: KClass<F>, to: KClass<T>) : io.icure.kraken.client.models.filter.IntersectionFilter<T> =
    io.icure.kraken.client.models.filter.IntersectionFilter(this.description, this.filters.map { it.toAbstractFilterDto(from, to) })
