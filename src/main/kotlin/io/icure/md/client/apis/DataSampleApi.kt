...
interface DataSampleApi {
    ...
    * @param nextDataSampleId The id of the first data sample in the next page (optional)
    * @param limit The number of data samples to return in the queried page (optional)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun filterDataSamples(filter: Filter<DataSample>, nextDataSampleId: kotlin.String?, limit: kotlin.Int?) : PaginatedListDataSample 
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getDataSampleAttachmentContent(dataSampleId: kotlin.String, documentId: kotlin.String, attachmentId: kotlin.String) : kotlinx.coroutines.flow.Flow<java.nio.ByteBuffer> 
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun matchDataSamples(filter: Filter<DataSample>) : kotlin.collections.List<kotlin.String> 
