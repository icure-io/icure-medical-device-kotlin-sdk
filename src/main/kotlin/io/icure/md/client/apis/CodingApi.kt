...
interface CodingApi {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun filterCoding(filter: Filter<Coding>, nextCodingId: kotlin.String?, limit: kotlin.Int?) : PaginatedListCoding 
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun matchCoding(filter: Filter<Coding>) : kotlin.collections.List<kotlin.String> 
