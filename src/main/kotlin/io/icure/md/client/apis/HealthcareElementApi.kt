...
interface HealthcareElementApi {
    ...
    suspend fun createOrModifyHealthcareElement(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun createOrModifyHealthcareElements(
        patientId: kotlin.String,
        healthcareElement: kotlin.collections.List<HealthcareElement>
    ): kotlin.collections.List<HealthcareElement>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun filterHealthcareElement(
        filter: Filter<HealthcareElement>,
        nextHealthElementId: kotlin.String?,
        limit: kotlin.Int?
